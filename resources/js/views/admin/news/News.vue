                ...
                <div class="block-content block-content-full">
                    <div class="table-responsive">
                        ...
                        >
                            <thead style="background-color: whitesmoke;">
                                <tr>
                                    ...
                                    <th
                                        ...
                                        @click="sortBy('news_title')"
                                    >
                                        Title
                                        <i
                                            class="fa fa-sort sort-icon"
                                            v-bind:class="{
                                                active: sort == 'news_title'
                                            }"
                                        ></i>
                                    </th>
                                    ...
                                    <th
                                        class="table-header-relative sort-head"
                                        @click="sortBy('news_username')"
                                    >
                                        Created By
                                        <i
                                            class="fa fa-sort sort-icon"
                                            v-bind:class="{
                                                active: sort == 'news_username'
                                            }"
                                        ></i>
                                    </th>
                                    <th
                            ...
                            <tbody
                                v-if="newsAll.data && newsAll.data.length > 0"
                            >
                                <router-link
                                    :to="{
                                        name: 'news-edit',
