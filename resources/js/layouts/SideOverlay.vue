                            ...
                            <div class="block-content">
                                ...
                                >
                                    <div class="form-group">
                                        <p class="font-w600 mb-2">Online Status</p>
                                    ...
                                    <hr />
                                    <div class="form-group">
                                        <p class="font-w600 mb-2">Auto Updates</p>
                                        <div class="custom-control custom-switch mb-1">
                                            <input
                                                type="checkbox"
                                                class="custom-control-input"
                                    ...
                                    <hr />
                                    <div class="form-group">
                                        <p class="font-w600 mb-1">Application Alerts</p>
                                        <div class="custom-control custom-switch mb-1">
                                            <input
                                                type="checkbox"
                                                class="custom-control-input"
                            ...
                            <div class="block-content">
                                <div class="row items-push pull-t">
                                    <div class="col-6">
                                        ...
                                        <a
                                            class="link-fx font-size-h3 font-w300"
                                            href="javascript:void(0)"
                                        >22.030</a>
                                    </div>
                                    <div class="col-6">
